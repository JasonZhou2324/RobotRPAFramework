...
from admin.system.views.message_center import MessageCenterTargetUserSerializer
...
def _get_message_center_instance(message_id):
    from admin.system.models import MessageCenter
...
def _get_message_unread(user_id):
    """获取用户的未读消息数量"""
    from admin.system.models import MessageCenterTargetUser
