...
MIDDLEWARE = [
    "admin.utils.middleware.HealthCheckMiddleware",
...
# 普通格式
STANDARD_LOG_FORMAT = "[%(asctime)s.%(msecs)03d][%(name)s.%(funcName)s():%(lineno)d] [%(levelname)s] %(message)s"

# 彩色格式（只用于控制台）
COLOR_LOG_FORMAT = (
    "%(log_color)s[%(asctime)s.%(msecs)03d][%(name)s.%(funcName)s():%(lineno)d] [%(levelname)s] %(message)s"
)
...
LOGGING = {
    ...
    "loggers": {
        "": {
            "handlers": ["console", "file", "error", "db"],
            "level": "DEBUG",
        },
        "django": {
            "handlers": ["console", "file", "error", "db"],
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_FILTER_BACKENDS": (
        ...
        "admin.utils.filters.CustomDjangoFilterBackend",
        "rest_framework.filters.SearchFilter",
        "rest_framework.filters.OrderingFilter",
    ),
    "DEFAULT_PAGINATION_CLASS": "admin.utils.pagination.CustomPagination",  # 自定义分页
    ...
    "EXCEPTION_HANDLER": "admin.utils.exception.CustomExceptionHandler",  # 自定义的异常处理
}
# ================================================= #
# ******************** 登录方式配置 ******************** #
# ================================================= #

AUTHENTICATION_BACKENDS = ["admin.utils.backends.CustomBackend"]
# ================================================= #
# ****************** simplejwt配置 ***************** #
# ================================================= #
SIMPLE_JWT = {
