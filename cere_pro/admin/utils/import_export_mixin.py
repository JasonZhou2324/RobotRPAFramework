...
from admin.utils.import_export import import_to_data
from admin.utils.json_response import DetailResponse, SuccessResponse
from admin.utils.request_util import get_verbose_name
from admin.system.tasks import async_export_data
...
class ImportSerializerMixin:
    ...
    def import_data(self, request: Request, *args, **kwargs):
        ...
        if request.method == "GET":
            ...
            # 导出excel 表
            response = HttpResponse(content_type="app/msexcel")
