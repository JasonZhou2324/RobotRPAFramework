...
from admin.system.models import MessageCenter, Users, MessageCenterTargetUser
from admin.utils.json_response import SuccessResponse, DetailResponse
...
class MessageCenterSerializer(CustomModelSerializer):
    ...
    def get_role_info(self, instance, parsed_query):
        ...
        from admin.system.views.role import RoleSerializer
    ...
    def get_user_info(self, instance, parsed_query):
        ...
        # You can do what ever you want in here
        # `parsed_query` param is passed to BookSerializer to allow further querying
        from admin.system.views.user import UserSerializer
    ...
    def get_dept_info(self, instance, parsed_query):
        ...
        from youi_admin.system.views.dept import DeptSerializer
